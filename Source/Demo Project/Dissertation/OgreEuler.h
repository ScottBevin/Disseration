...
public:
	...
	OgreEuler(Ogre::Radian y = Ogre::Radian(0.0f), Ogre::Radian p = Ogre::Radian(0.0f), Ogre::Radian r = Ogre::Radian(0.0f)):m_yaw(y),m_pitch(p),m_roll(r),m_changed(true) 
	{
	}
	...
	inline OgreEuler &yaw(Ogre::Radian y) 
	{
		m_yaw += y; 
	...
	inline OgreEuler &pitch(Ogre::Radian p) 
	{
		m_pitch += p; 
		m_changed = true; 
		return *this;
	...
	inline OgreEuler &roll(Ogre::Radian r) 
	{
		m_roll += r; 
		m_changed = true; 
		return *this;
	...
	// Set the yaw.
	inline OgreEuler &setYaw(Ogre::Radian y) 
	{
		m_yaw = y; 
		m_changed = true; 
		return *this;
	...
	// Set the pitch.
	inline OgreEuler &setPitch(Ogre::Radian p) 
	{
		m_pitch = p; 
		m_changed = true; 
		return *this;
	...
	// Set the roll.
	inline OgreEuler &setRoll(Ogre::Radian r) 
	{
		m_roll = r; 
		m_changed = true; 
		return *this;
	...
	// Casting operator. This allows any ogre function that wants a Quaternion to accept a OgreEuler instead.
	...
	// Roll is unaffected.
	OgreEuler &setDirection(const Ogre::Vector3 &v)
	{
	...
	// Only yaw is considered, pitch and roll are ignored.
	inline Ogre::Radian getYawToDirection(const OgreEuler &e)
	{
	...
	inline OgreEuler &yawToDirection(const Ogre::Vector3 &v)
	{
	...
	// Only yaw is changed, pitch and roll are ignored.
	inline OgreEuler &yawToDirection(const OgreEuler &e)
	{
	...
	inline friend std::ostream &operator<<(std::ostream &o, const OgreEuler &e)
	{
